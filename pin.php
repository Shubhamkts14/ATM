        ...
        <div class="col-xs-12" id="screenView">
          ...
          <div class="row">
            <div class="col-xs-8 text-center" style="border-right:solid 3px #CCC">
              ...
              <div id="confirmPin">
                <input type="submit"  class="btn btn-block btn-lg btn-success text-uppercase" value="Submit">&emsp;
                        <input type="submit"  class="btn btn-block btn-lg btn-danger text-uppercase" formaction="pin.php" value="Clear">
                            </form>
              </div>
             <!-- // Pin Pad -->
            </div> 
